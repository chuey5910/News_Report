...
- **"ข่าวทั่วไปวันนี้"**: เมนูปักหมุดด้านซ้าย (เหนือรายชื่อจังหวัด) — ข่าวที่ดึงมาแล้วแต่**ไม่ตรงกับ
  17 จังหวัดเลย** จะไม่ถูกตัดทิ้ง แต่ย้ายมารวมไว้ที่นี่แทน เพื่อไม่ให้พลาดข่าวที่น่าสนใจ/เป็นกระแส
  แม้จะไม่เกี่ยวกับพื้นที่เป้าหมาย (หมายเหตุ: ระบบยังไม่มีสัญญาณ "กระแสฮิต" จริง เช่น ยอดแชร์/ยอดวิว
  จึงแสดง**ข่าวทั้งหมดของวันนั้นที่ไม่ตรงจังหวัด** ให้เลือกดู/ค้นหาเองผ่าน filter เดียวกับหน้าอื่น — ถ้า
  ต้องการจัดอันดับ "ข่าวฮิต" จริงๆ ในอนาคต แนวทางที่ทำได้โดยไม่ใช้ AI คือนับว่าข่าวหัวข้อเดียวกันถูก
  หลายสำนักข่าวรายงานพร้อมกันกี่แหล่ง แล้วเรียงจากมากไปน้อย)
