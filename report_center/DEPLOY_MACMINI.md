...
ระบบส่งแจ้งเตือนเข้า LINE ได้ 2 แบบ: **ก่อนถึงกำหนดเวลาทำกิจกรรม 20 นาที** และ
**สรุปประจำเช้า (กิจกรรมวันนี้ + ล่วงหน้า 7 วัน)**
ตรวจสถานะโหมดส่ง + โควตาคงเหลือได้ด้วย: `.venv/bin/flask --app report_center line-status`
