...
|---|---|
| **ข่าวล่วงหน้า** | ชื่อกิจกรรม, วันเวลานัดหมาย, การขออนุญาต (ถ้ามี → ที่ไหน/กี่วัน), สถานที่นัดหมาย, ชื่อกลุ่ม, **แกนนำ (เลือกจำนวนคน → เพิ่มช่องชื่อ-นามสกุลตามจำนวน)**, จำนวนมวลชน, รูปแบบกิจกรรม, ข้อเรียกร้อง/วัตถุประสงค์, ผู้สนับสนุน, ความเชื่อมโยงกับบุคคล/องค์กรอื่น, สัมภาระค้างแรม/อุปกรณ์ (มี/ไม่มี → ถ้ามีเพิ่มช่องรายละเอียด), **ยานพาหนะ (มี/ไม่มี → ถ้ามีเลือกจำนวนคัน → เพิ่มช่องประเภท/ทะเบียน/จังหวัด/สีตามจำนวน)**, ข้อมูลน่าสนใจอื่นๆ, แนวโน้ม/ข้อพิจารณา, ผู้รายงาน, เบอร์ติดต่อ |
...
ฟิลด์ตัวหนา (แกนนำ/ยานพาหนะ) เก็บในตารางลูกแยกต่างหาก (`advance_news_leaders`,
`advance_news_vehicles`) ผูกกับข่าวล่วงหน้าแต่ละรายการ — เลือกจำนวนจาก dropdown แล้วช่องกรอกจะถูก
สร้างขึ้นอัตโนมัติด้วย JavaScript (`static/js/advance-form.js`) ฟิลด์ที่ขึ้นกับเงื่อนไข (การขออนุญาต/
สัมภาระ/ยานพาหนะ) จะซ่อน/แสดงอัตโนมัติ และฟิลด์ที่ถูกซ่อนอยู่จะไม่ถูกนำไปแสดงในหน้าต่างยืนยันก่อนบันทึก
